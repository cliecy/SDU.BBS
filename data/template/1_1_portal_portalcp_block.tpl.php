...
0
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_setting.htm', 1619512294, '1', './data/template/1_1_portal_portalcp_block.tpl.php', './template/default', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_thumbsetting.htm', 1619512294, '1', './data/template/1_1_portal_portalcp_block.tpl.php', './template/default', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_setting.htm', 1619512294, '1', './data/template/1_1_portal_portalcp_block.tpl.php', './template/default', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_thumbsetting.htm', 1619512294, '1', './data/template/1_1_portal_portalcp_block.tpl.php', './template/default', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_nav.htm', 1619512294, '1', './data/template/1_1_portal_portalcp_block.tpl.php', './template/default', 'portal/portalcp_block')
